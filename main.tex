...
Tracker software was used to extract maximum height data from video frames at 60 frames per second. These measured heights were used to calculate the gravitational potential energy reached by each popper at the top of its motion.
