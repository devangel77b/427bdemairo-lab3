...
Video data were analyzed using Tracker \cite{tracker,renike:2024:kinematics} to determine the maximum height ($h$) reached in each trial. Digitization proceeded similar to \cite{levine:2026:acceleration,dakwale:2026:effect,sharma:2026:analyzing,ahmadzada:2026:downward,hallur:2026:objects,brunie:2026:testing}. The measured heights were used to calculate the gravitational potential energy reached by each popper at the top of its motion according to:
\begin{equation}
\text{GPE}_f = mgh,
\end{equation}
